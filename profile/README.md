...
| --- | --- | --- |
| `frontend` | 사용자 화면 및 파일 업로드 UI | 예정 |
| `backend` | FastAPI 기반 API 서버 | 예정 |
| `database` | DB 스키마 및 저장 구조 관리 | 예정 |
| `llm-service` | 문서 요약 및 카테고리 분류 처리 | 예정 |
| `docs` | 프로젝트 문서 및 설계 자료 | 예정 |
...
필요한 경우 요약 결과 또는 분류 결과 파일을 다운로드할 수 있습니다.
